 ...
 * PMR:
 * 
 * + I switch to Eclipse and it is significantly better than BlueJ
 * + Easy tasks, the StringExplorer goes over stuff I already know
 * + Cool to see how chat bots work
 * 
 * - Very tedious work
 * 
 * 
...
public class Magpie2
{
    ...
    {
        String response = "";
        String emptyCheck = statement.trim();
        ...
        else if (statement.indexOf("Global Warming") >= 0)
        {
            response = "I know a lot about Global Warming. It's bad.";
        }
        ...
        {
            response = "The weather is very nice indeed.";
        }
        else if (emptyCheck.isEmpty() == true)
        {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "Let's talk about something else, Global Warming?";
        }
        else if (whichResponse == 5)
        {
            response = "Could you further elaborate?";
        }
